...
#define expr_new_dbl(val) expr_new_const(&(val))
...
#define expr_add_dbl(exp, val) expr_binary_const((exp), &(val), EXPR_ADD)
#define expr_sub_dbl(exp, val) expr_binary_const((exp), &(val), EXPR_SUB)
#define expr_mul_dbl(exp, val) expr_binary_const((exp), &(val), EXPR_MUL)
#define expr_div_dbl(exp, val) expr_binary_const((exp), &(val), EXPR_DIV)
#define expr_flrdiv_dbl(exp, val) expr_binary_const((exp), &(val), EXPR_FLRDIV)
#define expr_mod_dbl(exp, val) expr_binary_const((exp), &(val), EXPR_MOD)
#define expr_pow_dbl(exp, val) expr_binary_const((exp), &(val), EXPR_POW)
