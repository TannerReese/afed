...
// Unary operators
static nmsp_err_t neg_d(void *arg);

// Binary operators
static nmsp_err_t add_d(void *arg1, void *arg2);
static nmsp_err_t sub_d(void *arg1, void *arg2);
static nmsp_err_t mul_d(void *arg1, void *arg2);
static nmsp_err_t div_d(void *arg1, void *arg2);
static nmsp_err_t flrdiv_d(void *arg1, void *arg2);
static nmsp_err_t mod_d(void *arg1, void *arg2);
static nmsp_err_t pow_d(void *arg1, void *arg2);

// Builtin Functions
static nmsp_err_t abs_d(void *args);
static nmsp_err_t sqrt_d(void *args);
static nmsp_err_t log_d(void *args);
static nmsp_err_t ln_d(void *args);
static nmsp_err_t sin_d(void *args);
static nmsp_err_t cos_d(void *args);

// Constants
double pi_d = 3.14159265358979323846, e_d = 2.71828182845904523536;

// Define operators
struct bltn_info_s nmsp_bltns[] = {
...
const char *(*expr_arith_strerror)(nmsp_err_t err) = NULL;
...
nmsp_valctl_t nmsp_valctl = { sizeof(double), equal_d, NULL, clone_d, parse_d, print_d };
